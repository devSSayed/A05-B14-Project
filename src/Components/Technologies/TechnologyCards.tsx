    ...
    return (
        <div className="container mt-7 mx-auto flex  gap-9">
            <div className="hover-3d cursor-default" key={Technologys.key}>
                <div className={`${isMarked === true ? "border-2 border-[#DB2777]/50 min-h-44 rounded-3xl p-5 flex flex-col " : "border-2 border-gray-400/40 min-h-44 rounded-3xl p-5 flex flex-col "} ${selectedToStack.length === 0 ? "border-2 border-gray-400/40 min-h-44 rounded-3xl p-5 flex flex-col" : ""}`}>
                    ...
                    <div className="mt-auto">
                        ...
                        <button disabled={isMarked || selectedToStack.length > 0 ? true : false} dis onClick={() => handleSelectTechnology()} className={` ${isMarked === true ? "cursor-default bg-[#DB2777]/10 font-jakarta  font-medium py-3 rounded-xl text-[#DB2777] w-full" : "cursor-pointer bg-black font-jakarta  font-medium py-3 rounded-xl text-white w-full"} ${selectedToStack.length === 0 ? "cursor-pointer bg-black font-jakarta  font-medium py-3 rounded-xl text-white w-full" : ""}`}>
